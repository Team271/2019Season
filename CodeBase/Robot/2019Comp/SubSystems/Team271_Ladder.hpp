...
#define LADDER_INPUT_MAX_SCALE         ( 1.000f )
...
public:
   typedef enum : uint8_t
   {
      ...
      T271_LADDER_DATA_CAN_MOVE,
      T271_LADDER_DATA_VALUE,

      T271_LADDER_DATA_INPUT,
      T271_LADDER_DATA_INPUT_PREV,

      T271_LADDER_DATA_SETPOINT,
      T271_LADDER_DATA_POSITION,
      T271_LADDER_DATA_ERROR,
...
protected:
   ...
   Team271Shifter* _ShifterLock = nullptr;
    ...
    *
    */
   t271_ladder_mode_t ModePrev_ = T271_LADDER_MODE_MANUAL;
...
public:
   ...
   void ShiftGears( const eLadderLock argGear );
};
